...
<div class="text-center text-white mx-5 pb-3" id="Contacts">
    ...
    <div class="container-md w-md-50 text-start bg-dark rounded-3 my-3 py-3">
        ...
        <form action="../php/commenti.php" method="post">
            <div class="my-2">
                <label for="inputLibro" class="form-label m-0">Nome Libro</label>
                <input type="text" class="form-control" name="inputLibro" rows="10" placeholder="Suggerisci un libro da aggiungere...">
            </div>
            <div class="mb-2">
                <label for="inputDescrizione" class="form-label m-0">
                    Descrizione
                </label>
                <br />
                <textarea name="inputDescrizione" class="form-control" id="description" rows="10" placeholder="Aggiungi una descrizione..."></textarea>
            </div>
